...
export default function RecipeCard({ recipe = {}, onOpen, onSave, onRegenerate }) {
  ...
  return (
    <article className="bg-white rounded-xl shadow-card overflow-hidden hover:shadow-lg transition">
      <div className="h-44 md:h-48 w-full bg-slate-100">
        {image ? (
      ...
      <div className="p-4">
        <h3 className="text-lg font-semibold mb-1 line-clamp-2">{title || 'Untitled recipe'}</h3>

        <div className="text-sm text-slate-500 flex items-center gap-3 mb-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="ml-2 text-sm bg-brand-500 text-white px-3 py-1 rounded-xl"
            >
              Open
            </button>
          </div>
